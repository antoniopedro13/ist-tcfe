...
\par \noindent Also, the resistance, constants of the dependent sources and current values that were given by the \emph{Python} program are shown in the following table.
\vspace{5mm}
\begin{table}
\centering
